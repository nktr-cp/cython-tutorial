...
static PyMethodDef __pyx_mdef_9fibonacci_1fib = {"fib", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_9fibonacci_1fib, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_9fibonacci_1fib(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
...
*/
    ...
    __pyx_t_5 = 1;
    {
      ...
      if (__Pyx_VectorcallBuilder_AddArg(__pyx_mstate_global->__pyx_n_u_end, __pyx_mstate_global->__pyx_kp_u_, __pyx_t_6, __pyx_callargs+2, 0) < 0) __PYX_ERR(0, 4, __pyx_L1_error)
...
*/
    __pyx_t_2 = __pyx_v_b;
    __Pyx_INCREF(__pyx_t_2);
    __pyx_t_4 = PyNumber_Add(__pyx_v_a, __pyx_v_b); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 5, __pyx_L1_error)
